...
function Wallet() {
	...
	const fonbankDeposit = () => {
		...
		window.open(
			`https://pay.fonbnk.com/?source=${process.env.REACT_APP_SOURCE_PARAM}&asset=CUSD&country=NG&provider=mobile_money&network=CELO&minAmount=10&address=${cusdWallet[1].address}&freezeWallet=1&freezeNetwork=1&freezeAmount=1&redirectUrl=${process.env.REACT_APP_FRONTEND_BASE_URL}`,
			"_self"
		);
	};
